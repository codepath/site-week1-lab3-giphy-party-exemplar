  ...
  })()(
    {
        ...
        function (require, module, exports) {
          ...
          module.exports = function (_chai, util) {
            ...
            function Assertion(obj, msg, ssfi, lockSsfi) {
              ...
              flag(this, "has_custom_error_message", msg !== null && typeof msg !== "undefined")
            ...
            // NOTE JA: Updated this to give us info about whether or not we've added a custom message
            Assertion.prototype.assert = function (expr, msg, negateMsg, expected, _actual, showDiff) {
              ...
              if (!ok) {
                ...
                // console.log("assertionErrorKeys", Object.keys(assertionError))

                if (this.__flags.has_custom_error_message) {
                  // flag()
                  // conso
                  assertionError.hasCustomErrorMessage = true
                }
                // console.log("assertionKeys", Object.keys(this.__flags))
                // console.log("assertionFlags", this.__flags)
      ...
      7: [
        function (require, module, exports) {
          ...
          // NOTE JA: Updated this to let us know when we've passed a custom error message
          module.exports = function (chai, util) {
            chai.expect = function (val, message) {
              const newAssertion = new chai.Assertion(val, message)
              if (typeof message !== "undefined" && message !== null) {
                newAssertion.hasCustomErrorMessage = true
              }
              return newAssertion
            }
            ...
            chai.expect.fail = function (actual, expected, message, operator) {
              ...
              // console.log({ actual, expected, message, operator })

              message = message || "expect.fail()"
              const err = new chai.AssertionError(
                message,
                {
                  actual: actual,
                  expected: expected,
