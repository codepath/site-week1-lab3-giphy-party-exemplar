  ...
  var spy = function (chai, _) {
    ...
    Sandbox.prototype.on = function (object, methodName, fn) {
      ...
      if (methodName in object && !isMethod) {
        throw new Error(
          ['Unable to spy property "', methodName, '". Only methods and non-existing properties can be spied.'].join("")
        )
      }
    ...
    function assertWith() {
      ...
      if (always) {
        ...
        this.assert(
          ...
          "expected " +
            this._obj +
            " to have been always called with #{exp} but got " +
            passed +
            " out of " +
            calls.length,
    ...
    Assertion.addMethod("exactly", function () {
      ...
      if (always && _with) {
        ...
        this.assert(
          ...
          "expected " +
            this._obj +
            " to have been always called with exactly #{exp} but got " +
            passed +
            " out of " +
            calls.length,
        ...
        this.assert(
          ...
          "expected " +
            this._obj +
            " to have been called at the " +
            ordinalNumber +
            " time with exactly #{exp} but got #{act}",
